<?php namespace Barcamp\Talks\Updates\Classes;
...
class Seeder extends BaseSeeder
{
     ...
     *
     * - default folder e.g. /plugins/barcamp/talks/updates/sources/talks.yaml
     * - overwritten e.g.  /resources/barcamp/talks/updates/sources/talks.yaml
     *
     * @param $defaultPath
     *
     * @return string
